...
async function seed() {
    ...
    let uid;
    try {
        uid = (await firebase_1.auth.getUserByEmail(demoEmail)).uid;
    }
    catch {
    ...
    await Promise.all([
        ...
        firebase_1.db.collection('products').doc('iphone-16-pro').set({
            name: 'iPhone 16 Pro',
            category: 'iPhone',
            basePrice: 999,
            inStock: true,
        ...
        firebase_1.db.collection('products').doc('mbp-14-m4p-2024').set({
