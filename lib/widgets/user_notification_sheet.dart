...
/// Shows a draggable bottom sheet with user notifications.
void showUserNotificationsSheet(BuildContext context) {
  showModalBottomSheet<void>(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (sheetContext) => const _UserNotificationSheet(),
  );
}

class _UserNotificationSheet extends StatelessWidget {
  const _UserNotificationSheet();
                        ...
                        children: [
                          ...
                          if (store.unreadNotificationCount > 0)
                            TextButton(
                              ...
                              child: Text(AppLocalizations.of(context)?.markAllRead ?? 'Mark all read'),
                            ),
                        ],
                      ),
                    ),
